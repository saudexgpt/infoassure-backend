...
class RiskAssessment extends Model
{
    ...
    protected $fillable = ['client_id', 'due_diligence_response_id', 'due_diligence_question_id', 'vendor_id', 'impact_data', 'impact_on_areas', 'likelihood_of_occurence', 'likelihood_rationale', 'impact_of_occurence', 'impact_rationale', 'risk_score', 'risk_level', 'risk_level_color', 'treatment_option', 'treatment_option_details', 'recommended_control', 'control_effectiveness_level', 'revised_impact_data', 'revised_impact_on_areas', 'revised_likelihood_of_occurence', 'revised_likelihood_rationale', 'revised_impact_of_occurence', 'revised_impact_rationale', 'revised_risk_score', 'revised_risk_level', 'revised_risk_level_color', 'residual_risk_treatment_option', 'residual_treatment_option_details', 'status', 'target_closure_date', 'key_risk_indicator', 'comments'];
