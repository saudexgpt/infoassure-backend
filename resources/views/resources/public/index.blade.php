...
@section('content')
  ...
  <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
      <div class="row g-5">
        <div class="col-lg-12">
          <form method="GET" action="{{ route('public_resource_index', ['type' => $type]) }}">
            <div class="row">
              <div class="col-md-9">
                <div class="input-group input-group-outline mb-3">
                  <input class="form-control" type="text" name="search" placeholder="Search Resources Here...">
                </div>
              </div>
              <div class="col-md-3">
                <button class="btn btn-dark btn-round" type="submit">Search</button>
              </div>
            </div>
          </form>
        </div>
        <div class="col-lg-8">
          ...
          @else
            <div class="row g-5">
              <h1 class="display-4">Resource not available. </h1>
