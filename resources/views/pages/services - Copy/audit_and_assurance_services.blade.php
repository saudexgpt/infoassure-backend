        ...
        <div class="col-lg-12 wow slideInUp" data-wow-delay="0.3s">
          <div class="bg-light rounded">
            <div class="border-bottom py-4 px-5 mb-4">
              <h4 class="mb-3">We offer the following Audit & Assurance Services</h4>
            </div>
            <div class="p-5 pt-0">
    ...
    <div class="container py-5">
      <div class="row g-5">
        ...
        <div class="col-lg-5" style="min-height: 300px">
          <div class="position-relative">
            <img class="position-absolute w-100 rounded wow zoomIn" data-wow-delay="0.9s"
              src="/img/financial-statement.jpg">
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="management-system" class="detail-class container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
      <div class="row g-5">
        <div class="col-lg-7">
          <div class="section-title position-relative pb-3 mb-5">
            <h1 class="mb-0">Management Systems Certification Audit</h1>
          </div>
          <p class="mb-4" align="justify">
