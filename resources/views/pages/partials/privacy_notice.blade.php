<div style="max-height: 400px; overflow: auto">
  ...
  <p><strong>PERSONAL DATA COLLECTED: (NAME, EMAIL ADDRESS AND ALL OTHER PIIs CAPTURED ON OUR DATA COLLECTION
      POINTS)</strong></p>



  <p>Purpose of Processing <br><br>
...
<script>
  function showPrivacyPolicy() {
    ...
    document.getElementById('policy_notice_close').click()
    document.getElementById('privacy_policy_show').click()
  }
</script>