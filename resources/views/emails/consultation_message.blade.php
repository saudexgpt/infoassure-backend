                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div style="color: #4b4a4a; line-height: 190%; text-align: left; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 16px; line-height: 30.4px;">You have a consultation schedule with
                                    details given below<br /></span></p>
                                <p>
                                <div style="font-family: monospace;">
                                  <table width="100%">
                                    ...
                                    <tr>
                                      <td>Reason: </td>
                                      <td>{{ $data->subject != 'Others' ? $data->subject : $data->other_subject }}
                                      </td>
                                    </tr>
                                    {{-- <tr>
                                      <td>Message</td>
